@files = (
	['//project/propertySheet/property[propertyName="scripts"]/propertySheet/property[propertyName="jobTemplate"]/value', "properties/scripts/jobTemplate.xml"],
	['//project/propertySheet/property[propertyName="scripts"]/propertySheet/property[propertyName="perlCommonLib"]/value', "properties/scripts/perlCommonLib.xml"],
	['//project/propertySheet/property[propertyName="scripts"]/propertySheet/property[propertyName="perlHeader"]/value', "properties/scripts/perlHeader.xml"],
	['//project/propertySheet/property[propertyName="scripts"]/propertySheet/property[propertyName="perlHeaderJSON"]/value', "properties/scripts/perlHeaderJSON.xml"],
	['//project/propertySheet/property[propertyName="scripts"]/propertySheet/property[propertyName="perlLib"]/value', "properties/scripts/perlLib.xml"],
	['//project/propertySheet/property[propertyName="scripts"]/propertySheet/property[propertyName="perlLibJSON"]/value', "properties/scripts/perlLibJSON.xml"],

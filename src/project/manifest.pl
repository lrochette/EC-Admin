@files = (
	...
	['//project/procedure[procedureName="pluginWithGradle"]/step[stepName="create_gradlew"]/command', 'procedures/pluginWithGradle/steps/create_gradlew.pl'],
	['//project/procedure[procedureName="pluginWithGradle"]/step[stepName="create_build.gradle"]/command', 'procedures/pluginWithGradle/steps/create_build.gradle.pl'],

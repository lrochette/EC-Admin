@files = (
	...
	['//project/procedure[procedureName="agentMemoryConfiguration"]/step[stepName="restartAgent"]/command', 'procedures/agentMemoryConfiguration/steps/restartAgent.sh'],
	['//project/procedure[procedureName="agentMemoryConfiguration"]/step[stepName="pingResource"]/command', 'procedures/agentMemoryConfiguration/steps/pingResource.sh'],

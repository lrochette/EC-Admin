@files = (
	...
	['//project/procedure[procedureName="projectAsCode"]/step[stepName="create_ECInternal.gwt.xml"]/command', 'procedures/projectAsCode/steps/create_ECInternal.gwt.xml.pl'],

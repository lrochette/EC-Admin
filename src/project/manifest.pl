@files = (
	...
	['//project/procedure[procedureName="projectAsCode"]/step[stepName="create_createConfiguration_procedure"]/command', 'procedures/projectAsCode/steps/create_createConfiguration_procedure.sh'],
	...
	['//project/procedure[procedureName="sendAlert"]/step[stepName="sendEmail"]/command', 'procedures/sendAlert/steps/sendEmail.pl'],
